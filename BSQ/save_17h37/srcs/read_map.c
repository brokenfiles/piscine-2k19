...
/*   Updated: 2019/08/21 16:56:55 by llaurent         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		get_map(int index, int number, char *file_name, t_map *map, char *std)
{
	char	*content;
	char	**splitted;

	if (!(content = (std[0] == '\0' ? get_content(file_name) : std)))
